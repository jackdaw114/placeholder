        ...
        <Box>
            ...
            >
                {/* <Box sx={{ marginTop: '2em', width: '100%', height: "100%", display: 'flex', justifyContent: 'center' }}>
                    <Card className='add_card' sx={{ boxShadow: 'inset 0px 0px 15px black', borderRadius: 3, minWidth: '90vw', maxWidth: '90vw', maxHeight: '225px', minHeight: 100, backgroundColor: theme.palette.primary.light, display: 'flex', justifyContent: 'right' }}>

                        <Typography variant="h4" className="typoh4" sx={{ textAlign: 'right', maxWidth: '50%', marginRight: 3 }}><h4>
                            Hairdressin, Cutting, Styling & Braiding
                            <br />
                            <h2>50% off</h2>
                        </h4></Typography>
