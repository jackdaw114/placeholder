    ...
    return (
        <Box>
            ...
            <Box sx={{ marginTop: '2em', width: '100%', height: "100%", display: 'flex', justifyContent: 'center' }}>
                <Card className='add_card' sx={{ boxShadow: 'inset 0px 0px 15px black', borderRadius: 3, minWidth: '90vw', maxWidth: '90vw', minHeight: 100, backgroundColor: theme.palette.primary.light, display: 'flex', justifyContent: 'right' }}>

                    <Typography variant="h4" className="typoh4" sx={{ textAlign: 'right', verticalAlign: 'middle', maxWidth: '50%', marginRight: 3 }}><h4>discount for so anLorem ipsum dolor sit amet. Ut saepe placeat eum explicabo ullam aut accusantium temporibus. Est nesciuntd so lorem ipos</h4></Typography>
